...
const databaseURL = "https://word-cloud-17e51.firebaseio.com/";
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="텍스트 이름" 
                            ...
                            value={this.state.textName} onChange={this.handleValueChange} /><br /><br />
                        <input className={classes.hidden} 
                            accept="text/plain" id="raised-button-file" type="file" 
